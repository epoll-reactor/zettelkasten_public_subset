...
void list_speed_tests()
  {
    const size_t to_test { 100'000U };
    fun_benchmark("insert my list", 1, [] {
      epoll_reactor::list<int> l;
      for (size_t i { 0U }; i < to_test; ++i) {
        l.push_back(i);
      }
      assert(l.size() == to_test);
    });
    fun_benchmark("insert std list", 1, [] {
      std::list<int> l;
      for (size_t i { 0U }; i < to_test; ++i) {
        l.push_back(i);
      }
...
//    ListNode *left_runner{nullptr};
//    ListNode *right_runner{nullptr};
//
//    if (left->val <= right->val)
//    {
//        head = left_runner = left;
//        right_runner = right;
//    }
//    else
//    {
//        head = left_runner = right;
//        right = left;
//    }
//
//    if (!left_runner)
//    {
//        left_runner->next = right_runner;
//        return left;
//    }
//
...
//            left_runner = nullptr;
//        }
//        else if (right_runner->val <= left_runner->next->val)
//        {
//            ListNode *temporary = left_runner->next;
//            left_runner->next = right_runner;
//            right_runner = right_runner->next;
//            left_runner->next->next = temporary;
//        }
//        else left_runner = left_runner->next;
//    }
//
//    return head;
//}
